...
| proxyTimeoutInterval      | time after which a proxy will fail when communicating with database | no                        | string (duration) | 15s                               |
| proxyCheckInterval        | proxy check interval | no                        | string (duration) | 5s                                                  | no                        | string (duration) | 10s                                                                                                                                 |
