...
Currently the proxy redirects all requests to the master. There is a [feature request](https://github.com/storintlabs/stolon/issues/132) for using the proxy also for standbys but it's low in the priority list.
